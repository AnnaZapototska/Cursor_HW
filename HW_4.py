...
# 3. Determine which class a given Bus object belongs to
# (Check type of an object)
School_bus = Bus(95, 456000, 20)
...
# 6*. Create a new class SchoolBus that will inherit all of the
# methods from School and Bus and will have its own - bus_school_color
class SchoolBus(School, Bus):
    def __init__(self, max_speed, mileage, seat_capacity, get_school_id, number_of_students, bus_school_color):
...
#9. Override a printable string representation of the City
# class and return: The population of the city {name} is {population}
